...
-include vendor/amlogic/w17pro/BoardConfigVendor.mk
...
#Kernel
#TARGET_KERNEL_CONFIG := w17pro_defconfig
#TARGET_KERNEL_SOURCE := kernel/amlogic/w17pro
...
TARGET_BOOTLOADER_BOARD_NAME := w17ref
...
BOARD_EGL_CFG := device/amlogic/w17pro/egl.cfg
USE_OPENGL_RENDERER := true
ENABLE_WEBGL := true
BOARD_USE_SKIA_LCDTEXT := true

# CWM
TARGET_RECOVERY_INITRC := device/amlogic/w17pro/recovery.init.rc
...
TARGET_PREBUILT_KERNEL := device/amlogic/w17pro/kernel
BOARD_KERNEL_BASE := 0x40000000
BOARD_KERNEL_CMDLINE := console=ttyS0,115200 rw init=/init loglevel=8

TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/amlogic/w17pro/releasetools/amlogic_ota_from_target_files
