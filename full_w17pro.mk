...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/w17pro/overlay
...
# USB ModeSwitch
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/amlogic/w17pro/configs/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Prebuilt kernel modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/amlogic/w17pro/modules,system/lib/modules)
...
$(call inherit-product-if-exists, vendor/amlogic/w17pro/w17-vendor.mk)
